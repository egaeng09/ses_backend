...
public class AssignmentDto {
    ...
    public AssignmentDto(Long id, String title, String descripsion, LocalDateTime start_time, LocalDateTime end_time, Integer language, Long lessonId) {
        this.id = id;
        this.title = title;
